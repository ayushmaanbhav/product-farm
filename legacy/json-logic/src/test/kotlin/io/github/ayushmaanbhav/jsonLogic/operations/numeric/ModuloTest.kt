    ...
    withData(
        ...
        ts = listOf(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success(1.1.toBigDecimalDefaultContext())
            ),
            TestInput(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success((Int.MAX_VALUE + 3L).mod(3).toBigDecimalDefaultContext())
            ),
            TestInput(
                expression = mapOf("%" to listOf(Int.MIN_VALUE - 3L, -3)),
                result = JsonLogicResult.Success((Int.MIN_VALUE - 3L).mod(-3).toBigDecimalDefaultContext())
            ),
            TestInput(
                expression = mapOf("%" to listOf(listOf(listOf("5"), listOf(6)))),
