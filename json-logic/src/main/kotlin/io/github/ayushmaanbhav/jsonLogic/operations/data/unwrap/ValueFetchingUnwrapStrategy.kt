package io.github.ayushmaanbhav.jsonLogic.operations.data.unwrap

internal interface ValueFetchingUnwrapStrategy {
    fun unwrapDataKeys(expression: Any?, nestedVariablePathDelimiter: Char): List<String>? {
        ...
        return if (indexParts is List<*>) {
            ...
            indexParts?.toString()?.split(nestedVariablePathDelimiter).orEmpty()
        }
    }
