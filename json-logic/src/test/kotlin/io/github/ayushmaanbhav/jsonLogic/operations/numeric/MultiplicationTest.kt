    ...
    withData(
        ...
        ts = listOf(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success(8.toBigDecimalDefaultContext())
            ),
            TestInput(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success(5.1.toBigDecimalDefaultContext())
            ),
            TestInput(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success(125.toBigDecimalDefaultContext())
            ),
            TestInput(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success(30.toBigDecimalDefaultContext())
            ),
            TestInput(
